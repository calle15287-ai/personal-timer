...
class WinForm(QWidget):
    def __init__(self, parent=None):
        ...
        self.labelProgramm.setStyleSheet("border: 2px solid black; padding: 5px;")
        self.labelProgramm.setFont(QFont('Times', 15))
        
        self.labelPortug = QLabel('Portugues 0:00:00')
        self.labelPortug.setStyleSheet("border: 2px solid blue; padding: 5px;")
        self.labelPortug.setFont(QFont('Times', 15))
        
        self.labelPhilo = QLabel('Philosophy 0:00:00')
        self.labelPhilo.setStyleSheet("border: 2px solid yellow; padding: 5px;")
        ...
        self.resetBtn.setStyleSheet("background-color: #ff6b6b; color: white; font-weight: bold; padding: 8px;")
